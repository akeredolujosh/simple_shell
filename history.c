...
/**
  ...
  * Returns: A dynamically allocated string containing the history file.
  */
...
/**
  ...
  * @info: A structure containing parameters.
  * Returns: 1 if the operation is successful, otherwise -1.
  */
...
/**
  ...
  * @info: A structure containing parameters.
  * Returns: The number of history entries read if successful, otherwise 0.
  */
...
/**
  ...
  * @info: Structure containing potential arguments. Used to maintain.
  * Return: The new linecount of the history.
  */
