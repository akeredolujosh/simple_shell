...
/**
 * list_to_strings - This returns an array of strings of list->str
...
/**
 * print_list - It prints all the elements of linked list list_t
 * @h: The pointer to first node
 * Return: The size of list
 */
...
/**
 * node_starts_with - It returns the node whose string starts with prefix
